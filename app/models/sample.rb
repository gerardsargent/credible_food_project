class Sample < ApplicationRecord
    ...
    belongs_to :reading
    before_save :do_calc
    validates_presence_of :reading_number, :coverslip, :bacterial_number, :bacterial_size_shape,  :bacterial_dilution, :actinobacteria, :actinobacteria_dilution, :fungi, :fungi_diameter, :fungi_colour, :fungi_dilution, :oomycetes, :oomycetes_diameter, :oomycetes_colour, :oomycetes_dilution, :flagellate,:flagellate_dilution, :amoebae, :amoebae_dilution, :ciliates, :ciliates_dilution, :nematodes_bacteria, :nematodes_fungi, :nematodes_predator, :nematodes_root, :nematodes_dilution, :notes
